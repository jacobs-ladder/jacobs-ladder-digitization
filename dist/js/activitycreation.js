...
var ActivityInput = function (_React$Component2) {
	_inherits(ActivityInput, _React$Component2);

	function ActivityInput(props) {
		_classCallCheck(this, ActivityInput);

		var _this3 = _possibleConstructorReturn(this, (ActivityInput.__proto__ || Object.getPrototypeOf(ActivityInput)).call(this, props));
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement("input", { type: "text", name: "title", value: this.state.title,
						onChange: function onChange(evt) {
							return _this4.setState({ title: evt.target.value });
						} })
				),
				React.createElement(
					"p",
					...
					React.createElement(
						...
						{ name: "activity_type", value: this.state.type,
							onChange: function onChange(evt) {
								return _this4.setState({ type: evt.target.value });
							} },
						React.createElement(
							"option",
							{ value: "numbers" },
				...
				React.createElement(
					...
					React.createElement("textarea", { name: "instructions", rows: "10", cols: "50", value: this.state.instructions,
						onChange: function onChange(evt) {
							return _this4.setState({ instructions: evt.target.value });
						} })
				),
